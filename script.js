...
const i18n = {
  ja: {
    meta: {
      ...
      homeDescription: "大宮のBar 8 AM。カクテル、モクテル、ワイン、ビールを日本語と英語で見られるオンラインメニューです。",
      aboutTitle: "Bar 8 AM - 店舗情報",
      aboutDescription: "Bar 8 AMの店舗情報、アクセス、営業時間、オーナー紹介。",
      cocktailsTitle: "Bar 8 AM - カクテル",
      cocktailsDescription: "Bar 8 AMのカクテルメニュー。価格、味わい、材料、アルコール目安を掲載。",
      mocktailsTitle: "Bar 8 AM - モクテル",
      mocktailsDescription: "Bar 8 AMのノンアルコールメニュー。価格、味わい、材料を掲載。",
      winesTitle: "Bar 8 AM - ワイン",
      winesDescription: "Bar 8 AMのワインメニュー。グラス、ボトル、味わいの目安を掲載。",
      beersTitle: "Bar 8 AM - ビール",
      beersDescription: "Bar 8 AMのビールメニュー。クラフトビール、ラガー、黒ビールなどを掲載。",
    },
    nav: {
      home: "ホーム",
      cocktails: "カクテル",
    ...
    home: {
      ...
      quickInfoHours: "営業時間: 18:00-翌2:00（不定休）",
      quickInfoAddress: "場所: 大宮駅東口エリア",
      quickInfoContact: "予約・最新情報はInstagramをご確認ください。",
    ...
    about: {
      title: "店舗情報",
      introTitle: "Bar 8 AMへようこそ",
      introBody: "Bar 8 AMは、大宮で落ち着いた時間を楽しめるバーです。カクテル、モクテル、ワイン、ビールを、常連のお客様にも初めてのお客様にも選びやすくご案内します。",
      accessTitle: "アクセス",
      access1: "大宮駅東口を出ます",
      access2: "駅前通りを目印に徒歩約5分進みます",
      access3: "ローソン付近を左折します",
      access4: "Hotel Omiya付近、右手側の店舗をお探しください",
      contactTitle: "基本情報",
      hoursLabel: "営業時間",
      hoursValue: "18:00-翌2:00（不定休）",
      addressLabel: "住所",
      addressValue: "大宮駅東口エリア / Google MapsでBar 8 AMを検索",
      socialLabel: "最新情報",
      socialValue: "Instagramで営業日・イベント情報をご確認ください",
      ownerTitle: "オーナー紹介",
      ownerEyebrow: "ストーリー",
      ownerBody1: "オーナーのAkiraは、15年以上ミクソロジーに携わってきました。東京のカクテルバーでの経験を活かし、大宮でクラフトドリンクの魅力を届けています。",
      ownerBody2: "一杯のドリンクには物語があります。お客様に一口ごとに新しい体験を楽しんでいただきたいと考えています。",
      mapsCta: "Google Mapsを開く",
